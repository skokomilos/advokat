...
public class ExpandableAdapterRadnja extends BaseExpandableListAdapter {
    ...
    public Object getChild(int i, int i1) {
        return listHashMap.get(listDataHeader.get(i)).get(i1).getNaziv_radnje();   // i = group item, i1 = child item;
    }
